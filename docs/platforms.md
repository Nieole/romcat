...
**卡带世代的开工顺序由实测文件数定**（票 10）：FC（21,739）> SFC（5,790）> GB（5,684）> gba（2,536）> nds（1,338）> MD（385）。此前 research 给的 P0/P1/P2 排序基于资源站的全站分布，**不适用于这个库**——最刺眼的例子是街机：全站 12,522 条，这个库里只有 265 个文件。
